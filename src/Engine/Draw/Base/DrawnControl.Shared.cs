...
namespace DrawnUi.Draw
{
    ...
    public partial class DrawnControl :
        IHasAfterEffects,
        IDrawnControl
    {
        public DrawnControl()
        ...
        /// <returns></returns>
        public float AdaptWidthConstraintToRequest(float widthConstraint, ThicknessF constraints, double scale)
        {
        ...
        public virtual SizeF GetSizeRequest(float widthConstraint, float heightConstraint, bool insideLayout)
        {
            ...
            if (LockRatio > 0)
            {
                ...
                return new SizeF(lockValue, lockValue);
            }
        ...
        */
        ...
        public RectF RenderedAtDestination { get; set; }
        ...
        */
        ...
        public RectF GetMeasuringRectForChildren(float widthConstraint, float heightConstraint, double scale)
        {
            ...
            RectF rectForChild = new RectF(0, 0,
